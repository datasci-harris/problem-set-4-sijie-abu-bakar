...
```{python}
filepath1 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/pos2016.csv"
...
```{python}
filepath2 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/pos2017.csv"
pos2017 = pd.read_csv(filepath2)
pos2017["year"] = 2017
pos2017_short = pos2017[(pos2017["PRVDR_CTGRY_CD"] == 1) & (pos2017["PRVDR_CTGRY_SBTYP_CD"] == 1)]


filepath3 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/pos2018.csv"
...
filepath4 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/pos2019.csv"
...
corrected_closures = hospital_close_suspect[~hospital_close_suspect["ZIP_CD"].isin(zip_codes_to_filter)].reset_index()
...
```{python}
filepath1 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.dbf"
...
```{python}
filepath2 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.prj"
...
```
```{python}
filepath3 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.shp"
data3 = gpd.read_file(filepath3)
data3.head()
```
```{python}
filepath4 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.shx"
...
filepath5 = "/Users/naumanali/Desktop/4th Quarter/Python II/PS 4/problem-set-4-sijie-abu-bakar-main/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.xml"
...
```{python}
zip_tx = zip[zip["NAME"].str[:3].isin(["733"])|zip["NAME"].str[:2].isin(["75", "76", "77", "78", "79"])]
...
# Load zip and hospital data, assuming 'zips_texas_centroids' and 'zips_withhospital_centroids' are prepared from previous steps

# Ensure both GeoDataFrames are in the same projected CRS for accurate distance measurement
# EPSG:2272 (NAD83 / Pennsylvania South (ftUS)) or another suitable Texas projection (feet)
...
```{python}
# Ensure both the directly affected ZIP codes and Texas ZIP shapes GeoDataFrames are in the same coordinate system
# Assuming `closures_by_zip` contains directly affected ZIP codes, and `texas_zip_shapes` contains all Texas ZIP shapes
